...
st.set_page_config(page_title="Gaussian Blur Demo", page_icon="📈",layout="wide")

st.markdown("# Gaussian Noise Demo")
st.sidebar.header("Image selection")
st.write(
    """This demo shows the effects of `RandomBrightness` transformation and its parameters.
    Enjoy!"""
)
...
def get_transformation(limit: float):
    return A.RandomBrightness(limit=limit, always_apply=True)
