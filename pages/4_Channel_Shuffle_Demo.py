...
st.set_page_config(page_title="Channel Shuffle Demo", page_icon="📈",layout="wide")

st.markdown("# Channel Shuffle Demo")
st.sidebar.header("Image selection")
st.write(
    """This demo shows the effects of the `ChannelShuffle` transformation.
    Enjoy!"""
)
...
def get_transformation():
    return A.ChannelShuffle(always_apply=True)
